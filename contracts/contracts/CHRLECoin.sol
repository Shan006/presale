...
contract CHRLECoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CHARLIE", "CHRLE") {
    	...
    	marketingWallet = address(0x38FDE3327D97403912a9Da5e0D090ff4c2DC86fB); // set as marketing wallet
